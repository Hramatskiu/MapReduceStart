...
public class HbaseTaskApp {
  ...
  public static void main( String[] args ) throws Exception {
    ...
    if ( families != null ) {
      families.forEach( System.out::println );
        ...
        /*Job job = HBaseJobCreator.createJob(createConfig(), "Test",  HBaseQueryHelper.createScan(500, false),
        "sourcetest", "desttest");
         */
  ...
  private static void setUpHbaseTable( HTableHandlerWrapper hTableHandlerWrapper, String tableName,
                                       String familyName ) {
