...
public class OozieTaskApp extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        conf.setProperty(OozieClient.APP_PATH, "hdfs://svqxbdcn6hdp26secn1.pentahoqa.com:8020/user/devuser/examples/examples/app/map-reduce/workflow.xml");
        ...
        conf.setProperty("airawatOozieRoot", "hdfs://svqxbdcn6hdp26secn1.pentahoqa.com:8020/user/devuser/examples/examples/app/map-reduce");
