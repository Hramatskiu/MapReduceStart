...
public class SqoopConfigsCreator {
    public static Map<String, String> createConfigMapForJDBCConnector(String connectionString, String jdbcDriver, String username, String password){
    ...
    public static Map<String, String> createJobFromTableConfig(String shemaName, String tableName, String partitionColumn){
        Map<String, String> configMap = new HashMap<>();
