...
public class WordCountApp extends Configured implements Tool {
  ...
  private static JobConf createJob( JobConf configuration, Class<? extends org.apache.hadoop.mapred.Mapper> mapperClass,
                                    Class<? extends org.apache.hadoop.mapred.Reducer> reducerClass, String[] args )
    throws IOException {
