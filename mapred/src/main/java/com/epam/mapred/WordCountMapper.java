...
public class WordCountMapper extends MapReduceBase implements Mapper<Object, Text, Text, IntWritable> {
  ...
  @Override
  public void map( Object o, Text text, OutputCollector<Text, IntWritable> outputCollector, Reporter reporter )
    throws IOException {
  ...
  private void saveValueToCollector( OutputCollector<Text, IntWritable> outputCollector, String value )
    throws IOException {
    word.set( value );
