...
public class WordCountApp extends Configured implements Tool {
  ...
  private static Job createJob( JobConf configuration, Class<? extends Mapper> mapperClass,
                                Class<? extends Reducer> reducerClass, String[] args ) throws IOException {
  ...
  public static class WordCountReducer extends Reducer<Text, IntWritable, Text, IntWritable> {
    ...
    protected void reduce( Text key, Iterable<IntWritable> values, Context context )
      ...
      int sum =
        StreamSupport.stream( values.spliterator(), false ).map( IntWritable::get ).reduce( 0, ( a, b ) -> a + b );
